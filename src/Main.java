...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        MenuItem menu1 = new MenuItem(1, "Plain", 17.99);
        MenuItem menu2 = new MenuItem(2, "Pep", 13.99);
        MenuItem menu3 = new MenuItem(3, "Cheesy", 16.99);
        MenuItem menu4 = new MenuItem(4, "Organic", 26.99);
        MenuItem menu5 = new MenuItem(5, "Soda", 1.99);
        MenuItem menu6 = new MenuItem(6, "Salad", 10.99);
        MenuItem menu7 = new MenuItem(7, "Pasta", 6.99);
